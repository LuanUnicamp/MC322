public class CartaDanoVeneno extends CartaDano{
    ...
    public void usar_h(Heroi h,Inimigo i,Combate combate){
        ...
        Veneno veneno_heroi=new Veneno(" Veneno Vontade do Fogo", i, this.veneno,"VENENO");
    ...
    public void usar_i(Inimigo i,Heroi h,Combate combate){
        ...
        Veneno veneno_inimigo = new Veneno(" Veneno Tsukuyomi Infinito", h, this.veneno,"VENENO");
